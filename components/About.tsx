			...
			<div className="container grid grid-cols-1 md:grid-cols-2 gap-8">
				...
				<div>
					...
					<div className="text-sm space-y-3 leading-8 mt-4">
						<p>
							Born in Lagos on April 20, 1962, Prince Adedapo
							Oluwaseyi Adelegan, known as Dapo, embodies a rich
							tapestry of education, entrepreneurship, and
							leadership. His journey commenced at Ladi-lak
							Institute in Yaba for primary education, followed by
							the prestigious CMS Grammar School, Lagos, where he
							completed his O levels. He pursued his A levels at
							the School of Arts and Science in Ikare, Ondo State,
							culminating in his academic foundation.
						</p>
						<p>
